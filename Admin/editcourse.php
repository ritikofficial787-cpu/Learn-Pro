...
<form action="" method="POST" enctype="multipart/form-data">
    <div class="form-group">
        ...
        name="course_id" value="<?php if(isset($row['course_id'])){echo $row['course_id']; }?>" readonly>
    </div>
  ...
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      id="course_original_price" name="course_original_price"  value="<?php if(isset($row['course_original_price'])
...
<div class="form-group">
  ...
  <img src="<?php if(isset($row['course_img'])) { echo $row['course_img']; } ?>" 
       alt="Course Image" class="img-thumbnail" style="width: 150px; margin-bottom: 10px;">
